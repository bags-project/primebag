 ...
 */
final class Version20181217205014 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tag CHANGE name name VARCHAR(10) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
